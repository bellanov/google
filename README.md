...
The project is deployed across multiple _environments_, each of which has its own Terraform configuration.
...
_Terraform_ configurations are located in the `terraform/environments` directory.

### Environment Variables

The project relies on _environment variables_ to execute.
...
The project uses _[Direct Workload Identity Federation](https://github.com/google-github-actions/auth?tab=readme-ov-file#preferred-direct-workload-identity-federation)_ to manage identities and access across different environments.
